  ...
  return (
    ...
    >
      ...
      <p className="max-w-4xl text-center mx-auto">
        ...
        critically, solve complex problems, and approach challenges with a
        structured, analytical mindset.
      </p>

      <p className="max-w-4xl text-center mx-auto mt-4">
        ...
        on backend systems, experimenting with new frameworks, or collaborating
        on team projects, I’m driven by the excitement of turning ideas into
        working software.
      </p>
